  ...
  return (
    <div className={`relative ${className}`} ref={ref}>
      ...
      <button
        type="button"
        onClick={() => setOpen((v) => !v)}
        className="w-full px-3 py-2 bg-white border border-gray-300 rounded-md text-sm flex items-center justify-between hover:bg-gray-50 focus:ring-red-500 focus:outline-none focus:ring-2"
      >
